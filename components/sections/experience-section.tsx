  ...
  return (
    <section id="experience" className="px-4 py-24" aria-labelledby="experience-title">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-8 border border-cyber-green/25 bg-black/40 p-5 font-mono text-sm text-white/70">
          <span className="text-cyber-green">ROLE:</span> Software Engineer
          ...
          {missions.map((mission, index) => (
            ...
            >
              <div className="flex items-center justify-between gap-4">
                <span className="font-mono text-xs font-black text-cyber-green">{mission.id}</span>
